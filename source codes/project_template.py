...
def pcl_callback(pcl_msg):
    ##pcl_received_pub.publish(pcl_msg)
...
# Exercise-2 TODOs:
    ...
    extracted_outliers_filtered = outlier_filter.filter()

    # TODO: Euclidean Clustering
    white_cloud = XYZRGB_to_XYZ(extracted_outliers_filtered)
...
# Exercise-3 TODOs: 
    ...
    for index, pts_list in enumerate(cluster_indices):
        ...
        pcl_cluster = extracted_outliers_filtered.extract(pts_list)
...
if __name__ == '__main__':
    ...
    ##pcl_received_pub = rospy.Publisher("/pcl_received", PointCloud2, queue_size=1)
